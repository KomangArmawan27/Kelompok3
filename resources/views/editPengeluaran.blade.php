            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="/updatePengeluaran" method="post">
                        @foreach($editPengeluaran as $key => $tabel)
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_pengeluaran" value="{{ $tabel->jumlah_pengeluaran }}" name="jumlah_pengeluaran">
                        </div>
                        <div class="form-group">
                            <label for="Penggunaan">Penggunaan Untuk</label>
                            <input type="text" class="form-control" id="penggunaan" name="penggunaan" value="{{ $tabel->penggunaan }}">
                        </div>
