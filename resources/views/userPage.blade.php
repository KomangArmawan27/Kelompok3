...
<head>
    ...
    <!-- Favicons -->
    <link href="asset/img/LOGO KOPMA.png" rel="icon">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#">Barang</a></li>
                    <li><a class="nav-link scrollto" href="#">Petugas Piket</a></li>
                    <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
                    <li><a class="getstarted scrollto" href="#about">Mulai</a></li>
                    <li class="dropdown"><a class="getstarted scrollto" href="#">Login</a>
                        <ul>
                            <li><a href="#">Login Sebagai Admin</a></li>
                            <li><a href="#">Login Sebagai User</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Kita menyediakan barang dan jasa dalam kebutuhan kuliah dan bersekolah</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Berisikan anggota BEM yang selalu siap sedia dilokasi dengan jadwal piket yang sudah ada</h2>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="content">
                            <h3>KOPMA itu apa?</h3>
                            <h2>KOPMA adalah singkatan dari Koperasi Mahasiswa.</h2>
                            <p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="box">
                            ...
                            <p>Dengan harga yang terjangkau yang mengikuti standard pasar</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="box">
                            ...
                            <p>Petugas yang bertugas secara cepat melayani pelanggan</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                        <div class="box">
                            ...
                            <h3>Ramah</h3>
                            <p>Petugas yang ramah dan baik</p>
                        </div>
                    </div>
        ...
        <section id="features" class="features">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h2>Peralatan</h2>
                    <p>Peralatan yang dimiliki oleh KOPMA untuk mengerjakan pekerjaan yang diminta</p>
                </header>
        ...
        <section id="services" class="services">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h2>Jasa</h2>
                    <p>KOPMA menyediakan berbagai jasa pelayanan</p>
                </header>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <a href="#services">Jasa</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Barang</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Petugas Piket</a></li>
                        </ul>
                    </div>
